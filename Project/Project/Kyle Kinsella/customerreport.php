...
<head>
    ...
    <link rel="stylesheet" href="customerReport.css"/>
</head>
<body>
...
<!--
    Name: Kyle Kinsella
    Purpose of screen: Show a report of everything in the Customer table in a nice html table 
    Student ID, name and date written: C00273146, Kyle Kinsella, 13/3/23
-->
