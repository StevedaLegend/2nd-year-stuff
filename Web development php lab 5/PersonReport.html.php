...
onclick='emailaddressOrder()' title = "Click here to check each persons email address">
<br>
<br>
...
?>
    ...
    document.getElementById{"emailButton"}.disaled = true
    </script>
<?php
