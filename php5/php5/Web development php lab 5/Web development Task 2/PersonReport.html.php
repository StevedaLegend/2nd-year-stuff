...
<body>
    <?php include "menu.php"; //menu connection
    ...
    <!-- Purpose: To view the person report table with the information saved to the database  -->
    ...
    <!--Buttons are used for each order from DOB to Surname to Email-->
    ...
    <script>
        ...
        // We use the Order functoion to organise the DOb Surname and Emails
    ...
    } else // id ($choice == "Surname") or the default display before any button is clicked 
    {
        ...
        <script>
            ...
            docuemnt.getELementById{ "dateButton" }.disabled = false;
        </script>
        <?php
    ...
    function produceReport($con, $sql)
    {
        ...
        // Echo out the table with the information from the database
        echo "<table
