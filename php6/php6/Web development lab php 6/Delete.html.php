...
// Populate the listbox in the database using populate 
function populate()
{
...
// To confirm if the user wants to delete the perosn in the database 
...
<!--Using form we enter in details and confirm check if we want to save the details that we enter in--> 
<p id = "display"> </p>
...
<?php 
        if(ISSET($_SESSION["delid"])) {echo "<h1 class='myMessage'>Recording deleted for".
        $_SESSION["delfirstname"] . " " .$_SESSION["dellastname"]."</h1>";}
        session_destroy();
?>
</body>
</html>