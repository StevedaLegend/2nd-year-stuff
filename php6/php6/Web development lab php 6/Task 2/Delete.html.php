...
// Use the populate function to populate the listbox
function populate()
{
...
// Use confirm check to see if this user wants to delete the person in the database
...
<?php 
		...
		// Prints out who has been deleted in the database
